...
texreg::screenreg(m1a <- lm(access1 ~ gwf_regimetype4 + undp_hdi + logpop + e_regionpol_7C, data = aut))
texreg::screenreg(m1b <- lm(access1 ~ kailitz_regime + undp_hdi + logpop + e_regionpol_7C , data = aut))
texreg::screenreg(m1c <- lm(access1 ~ wth_regime + undp_hdi + logpop + e_regionpol_7C , data = aut))
